...
urlpatterns = [
    ...
    path('favicon.ico', RedirectView.as_view(url='/static/estate/images/logos/favicon.png', permanent=True)),
...
# Serve media files (images, uploads) - using re_path since static() only works with DEBUG=True
urlpatterns += [
