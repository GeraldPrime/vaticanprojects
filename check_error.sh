...
echo "-----------------------------------"
tail -100 /opt/vaticanprojects/vaticanprojects/vaticanprojects/django.log 2>/dev/null | grep -A 20 "500\|Error\|Exception\|Traceback" | tail -50

echo ""
echo "2. Checking Gunicorn logs:"
echo "-----------------------------------"
journalctl -u vaticanprojects -n 50 --no-pager 2>/dev/null | grep -A 20 "500\|Error\|Exception\|Traceback" | tail -50
